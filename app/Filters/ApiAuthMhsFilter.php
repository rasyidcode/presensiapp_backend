...
class ApiAuthMhsFilter implements FilterInterface
{
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if ($decodedData->data->level != 'mahasiswa')
            throw new ApiAccessErrorException('You are not allowed to access this resources', ResponseInterface::HTTP_FORBIDDEN);
