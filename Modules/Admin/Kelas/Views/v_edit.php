            ...
            <div class="col-lg-12">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= route_to('kelas.update', $editData->id) ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="form-group">
                                ...
                                <select name="matkul" class="form-control">
                                    ...
                                    <?php foreach($matkulList as $matkulListItem): ?>
                                        <option value="<?=$matkulListItem->id?>" <?=$editData->id_matkul == $matkulListItem->id ? 'selected' : ''?>><?=$matkulListItem->kode?> - <?=$matkulListItem->nama?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="dosen" class="form-control">
                                    ...
                                    <?php foreach($dosenList as $dosenListItem): ?>
                                        <option value="<?=$dosenListItem->id?>" <?=$editData->id_dosen == $dosenListItem->id ? 'selected' : ''?>><?=$dosenListItem->nama_lengkap?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
