            ...
            <div class="col-lg-12">
                <div class="card card-outline card-primary">
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= route_to('jadwal.update', $editData->id) ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="form-group">
                                ...
                                <select name="kelas" class="form-control">
                                    ...
                                    <?php foreach ($kelasList as $kelasListItem) : ?>
                                        <option value="<?= $kelasListItem->id ?>" <?=$editData->id_kelas == $kelasListItem->id ? 'selected' : ''?>><?= $kelasListItem->kelas ?> - <?= $kelasListItem->matkul ?> - <?= $kelasListItem->dosen ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="input-group date" id="tanggal" data-target-input="nearest">
                                    <input type="text" name="tanggal" class="form-control datetimepicker-input" data-target="#tanggal" value="<?=$editData->date?>" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group clockpicker-begin-time">
                                    <input type="text" name="beginTime" class="form-control" value="<?=$editData->jam_mulai?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group clockpicker-end-time">
                                    <input type="text" name="endTime" class="form-control" value="<?=$editData->jam_selesai?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
